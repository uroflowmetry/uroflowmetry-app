...
package com.uroflowmetry.camera;
...
public class FocusManager {
    ...
    // This has to be initialized before preInitialize().
    ...
    public void initialize(View previewFrame, Listener listener, int displayOrientation) {
        ...
        CameraUtil.prepareMatrix(matrix, false, displayOrientation,
    ...
    public void calculateTapArea(int focusWidth, int focusHeight, float areaMultiple,
        ...
        int left = CameraUtil.clamp(x - areaWidth / 2, 0, previewWidth - areaWidth);
        int top = CameraUtil.clamp(y - areaHeight / 2, 0, previewHeight - areaHeight);
